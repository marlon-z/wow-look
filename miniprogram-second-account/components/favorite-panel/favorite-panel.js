  ...
  methods: {
    ...
    drawFavoritePosterPage(posterPage, posterMeta) {
      return loadPosterIconMap(posterPage).then((iconMap) => {
        ...
        drawStrokedText(ctx, '收藏夹·艾泽拉斯装备搭配', POSTER_WIDTH / 2, 92, 'rgba(0, 0, 0, 0.92)', 7);
        ...
        drawStrokedText(ctx, '微信小程序搜索「艾泽拉斯装备搭配」', POSTER_WIDTH / 2, POSTER_HEIGHT - 68, 'rgba(0, 0, 0, 0.86)', 4);
        ctx.setShadow(0, 0, 0, 'transparent');
